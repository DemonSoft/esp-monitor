...
1. При включении микроконтроллеера, если в файловой системе отсуствует файл config.json, микроконтроллер поднимает точку доступа c ssid = "esp8266-setup" (или "esp32-setup") и паролем "1qazxsw2"; запускает веб-сервер для обработки REST запроса по адресу 192.168.4.1 на 80-м порту. 
